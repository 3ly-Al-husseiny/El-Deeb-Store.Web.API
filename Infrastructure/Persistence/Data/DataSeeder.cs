        ...
        try
        {
            ...
            if (!_dbContext.ProductBrands.Any())
            {
                var productBrandsData =
                    File.OpenRead("../Infrastructure/Persistence/Data/DataSeedingFiles/brands.json");
            ...
            {
                var productTypesData = File.OpenRead("../Infrastructure/Persistence/Data/DataSeedingFiles/types.json");
            ...
            {
                var productsData = File.OpenRead("../Infrastructure/Persistence/Data/DataSeedingFiles/products.json");
